...
namespace charwidth::v_12_0_0 {

using Node = details::Node;

inline constexpr Node kWidth1[860] = {
	{0x20, 0x7e},
	{0xa0, 0xa0},
	{0xa2, 0xa3},
	{0xa5, 0xa6},
...
inline constexpr Node kWidth2[114] = {
	{0x1100, 0x115f},
	{0x231a, 0x231b},
	{0x2329, 0x232a},
	{0x23e9, 0x23ec},
...
inline int CharWidth(c32 c) {
	if (IsInRanges(kWidth1, 860, c)) return 1;
	if (IsInRanges(kWidth2, 114, c)) return 2;
