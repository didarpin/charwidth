...
namespace charwidth::v_8_0_0 {

using Node = details::Node;

inline constexpr Node kWidth1[769] = {
	{0x20, 0x7e},
	{0xa0, 0xa0},
	{0xa2, 0xa3},
	{0xa5, 0xa6},
...
inline constexpr Node kWidth2[35] = {
	{0x1100, 0x115f},
	{0x2329, 0x232a},
	{0x2e80, 0x2e99},
	{0x2e9b, 0x2ef3},
...
inline constexpr Node kWidthAmbiguous[173] = {
	{0xa1, 0xa1},
	{0xa4, 0xa4},
	{0xa7, 0xa8},
	{0xaa, 0xaa},
...
inline int CharWidth(u32 c) {
	if (IsInRanges(kWidth1, 769, c)) return 1;
	if (IsInRanges(kWidth2, 35, c)) return 2;
	if (IsInRanges(kWidthAmbiguous, 173, c)) return ambiguous_width;
