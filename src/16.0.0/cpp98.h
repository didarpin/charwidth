...
class G {
public:
	static const Node kWidth1[940];
	static const Node kWidth2[122];
	static const Node kWidthAmbiguous[179];
	static int ambiguous_width;
};

const Node G::kWidth1[940] = {
	{0x20, 0x7e},
	{0xa0, 0xa0},
	{0xa2, 0xa3},
	{0xa5, 0xa6},
...
inline int CharWidth(u32 c) {
	if (IsInRanges(G::kWidth1, 940, c)) return 1;
	if (IsInRanges(G::kWidth2, 122, c)) return 2;
