...
inline constexpr Node kWidth1[809] = {
	{0x20, 0x7e},
	{0xa0, 0x377},
	{0x37a, 0x37f},
	{0x384, 0x38a},
...
inline constexpr Node kWidth2[124] = {
	{0x1100, 0x115f},
	{0x231a, 0x231b},
	{0x2329, 0x232a},
	{0x23e9, 0x23ec},
...
inline int CharWidth(c32 c) {
	if (details::IsInRanges(details::kWidth1, 809, c)) return 1;
	if (details::IsInRanges(details::kWidth2, 124, c)) return 2;
	return 0;
}
