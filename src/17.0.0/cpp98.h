...
class G {
public:
	static const Node kWidth1[946];
	static const Node kWidth2[123];
	static const Node kWidthAmbiguous[179];
	static int ambiguous_width;
};

const Node G::kWidth1[946] = {
	{0x20, 0x7e},
	{0xa0, 0xa0},
	{0xa2, 0xa3},
	{0xa5, 0xa6},
...
const Node G::kWidthAmbiguous[179] = {
	{0xa1, 0xa1},
	{0xa4, 0xa4},
	{0xa7, 0xa8},
	{0xaa, 0xaa},
...
inline int CharWidth(c32 c) {
	if (IsInRanges(G::kWidth1, 946, c)) return 1;
	if (IsInRanges(G::kWidth2, 123, c)) return 2;
