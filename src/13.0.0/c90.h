...
static int _CW_13_0_0_IsInRanges(_CW_Node const* ranges, size_t size, cw_c32 c) {
	size_t low = 0;
	size_t high = size;
	size_t mid;
...
static int _CW_13_0_0_SetAmbiguousWidth(int w) {
	_cw_13_0_0_ambiguous_width = w;
	return 0;
}

static int _CW_13_0_0_CharWidth(cw_c32 c) {
