...
class G {
public:
	static const Node kWidth1[752];
	static const Node kWidth2[35];
	static const Node kWidthAmbiguous[173];
	static int ambiguous_width;
};

const Node G::kWidth1[752] = {
	{0x20, 0x7e},
	{0xa0, 0xa0},
	{0xa2, 0xa3},
	{0xa5, 0xa6},
...
const Node G::kWidthAmbiguous[173] = {
	{0xa1, 0xa1},
	{0xa4, 0xa4},
	{0xa7, 0xa8},
	{0xaa, 0xaa},
