...
class G {
public:
	static constexpr std::array<Node, 791> kWidth0 = {
		Node{0x0, 0x1f},
		Node{0x7f, 0x9f},
		Node{0x378, 0x379},
		Node{0x380, 0x383},
	...
	static constexpr std::array<Node, 808> kWidth1 = {
		Node{0x20, 0x7e},
		Node{0xa0, 0x377},
		Node{0x37a, 0x37f},
		Node{0x384, 0x38a},
	...
	static constexpr std::array<Node, 123> kWidth2 = {
		Node{0x1100, 0x115f},
		Node{0x231a, 0x231b},
		Node{0x2329, 0x232a},
		Node{0x23e9, 0x23ec},
...
constexpr std::array<Node, 791> G::kWidth0;
...
inline u32 CharWidth(c32 c) {
	if (details::IsInRanges(details::G::kWidth0.data(), details::G::kWidth0.size(), c)) return 0;
	if (details::IsInRanges(details::G::kWidth1.data(), details::G::kWidth1.size(), c)) return 1;
	if (details::IsInRanges(details::G::kWidth2.data(), details::G::kWidth2.size(), c)) return 2;
	return 0;
}
